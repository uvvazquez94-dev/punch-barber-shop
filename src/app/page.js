...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0b1f3a] text-white">
      {/* NAVBAR */}
      <nav className="flex justify-center items-center px-6 py-4 bg-white border-b border-[#14253a]/10">
...
<h2 className="text-2xl md:text-4xl font-medium tracking-wide leading-tight text-[#ede3da]">
            CLASSIC CUTS. MODERN STANDARDS.
          </h2>

          <p className="mt-4 text-base md:text-lg text-gray-300 max-w-lg mx-auto">
            Traditional barbering with a modern finish in Glen Ellyn.
          </p>
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <a
              href="#services"
              className="border border-[#ede3da] px-6 py-3 rounded-lg hover:bg-[#ede3da] hover:text-[#0b1f3a] transition duration-200"
            >
              View Services
            </a>
          </div>
      ...
      <section id="services">
        {/* TITLE */}
        <div className="bg-[#ede3da] py-16 px-6 text-center">
          <motion.h3
            variants={fadeUp}
            initial="hidden"
            whileInView="show"
        ...
        {/* GALLERY */}
        <div className="bg-[#ede3da] pb-24 px-6">
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="show"
        ...
        >
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-x-12 gap-y-6 text-[#ede3da] text-lg">
            <div className="flex items-end gap-3">
              <span>Men&apos;s Cut</span>
              <span className="flex-1 border-b border-dotted border-[#ede3da]/40"></span>
              <span>$30</span>
            </div>
      ...
      <div className="bg-[#0b1f3a] py-12">
        <div className="max-w-6xl mx-auto flex justify-center">
          <div className="w-3/4 h-[1px] bg-gradient-to-r from-transparent via-[#ede3da]/100 to-transparent"></div>
        </div>
      </div>
      ...
      <section id="about" className="bg-[#0b1f3a] text-white py-24 px-6">
        ...
        >
          <div>
            <h3 className="text-3xl md:text-4xl font-bold text-[#ede3da] mb-6">
              About Punch
            </h3>

            <p className="text-gray-300 leading-relaxed mb-6">
              Located in Downtown Glen Ellyn, Punch Barber Shop delivers quality cuts, classic service, and a modern experience. Since 2013, we’ve built our reputation on skilled craftsmanship, fair pricing, and a commitment to keeping every client looking sharp.
            </p>
          ...
          <div
  id="contact"
  className="bg-[#ede3da] text-[#0b1f3a] rounded-2xl p-6 md:p-8 shadow-lg"
>
  <div className="grid md:grid-cols-2 gap-6 items-start">
    ...
    <div>
      ...
      <div className="space-y-4 text-sm md:text-base">
        <p>
          <a
            href="https://maps.google.com/?q=491+Pennsylvania+Ave+Glen+Ellyn"
            target="_blank"
            className="underline"
          >
  ...
  Sun–Mon: Closed
    ...
    {/* RIGHT SIDE (MAP) */}
    <div className="w-full h-[250px] md:h-full rounded-xl overflow-hidden border border-[#0b1f3a]/10">
      <iframe
...
<section className="bg-white py-12 px-6">
  <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
    <img
      ...
      className="w-56 md:w-72 object-contain mb-4"
    />

    <p className="text-[#14253a] text-sm">
      © 2026 Punch Barber Shop of Glen Ellyn. All Rights Reserved.
    </p>
  </div>
</section>
    </main>
